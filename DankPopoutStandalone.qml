...
Item {
    ...
    readonly property bool backgroundDismissWindowRequired: false // backgroundInteractive
    readonly property bool backgroundWindowRequired: false // backgroundDismissWindowRequired || root.overlayContent !== null
    ...
    readonly property real alignedX: Theme.snap((screenWidth - popupWidth) / 2, dpr)
    /*
    ...
    */
    ...
    readonly property real alignedY: Theme.snap((screenHeight - popupHeight) / 2, dpr)
    /*
